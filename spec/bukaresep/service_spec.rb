...
RSpec.describe Bukaresep::Service do
  ...
  describe '#add' do
    before(:each) do
      ...
      allow(repository).to receive(:add){ Bukaresep::Recipe.new }
    end

    context 'valid recipe' do
      it do
        expect(repository).to receive(:add)
    ...
    context 'invalid recipe' do
      it do
        expect(repository).to_not receive(:add)
  ...
  describe '#get' do
    context 'get recipe by id' do
      ...
      before(:each) do
        allow(repository).to receive(:get){ recipe }
      end
    ...
    context 'get all recipe' do
      ...
      before(:each) do
        allow(repository).to receive(:all){ recipes }
      end
  ...
  describe '#update' do
    before(:each) do
      ...
      allow(repository).to receive(:update){ Bukaresep::Recipe.new }
    end
    ...
    context 'invalid recipe' do
      it do
        expect(repository).to_not receive(:update)
